        ...
        <table class="table table-hover table-striped" id="tbl_datos">
          ...
          <tbody>
            ...
            if(isset($_GET['fecha'])){
              ...
              $consul=$conexion->query("SELECT * from tb_gastos where fecha>='".$fecha1."' and fecha<='".$fecha2."'");
            }else{
              $consul=$conexion->query("SELECT * from tb_gastos");
            }
              while($resp=mysqli_fetch_array($consul)){
             ?>
            <tr>
              <td><?php echo $resp['id_gastos']; ?></td>
              <td><?php echo $resp['factura']; ?></td>
              <td><?php echo $resp['fecha']; ?></td>
              <td><?php echo $resp['descripcion'] ?></td>
              <td><?php echo $resp['valor']; ?></td>
            </tr>
            <?php 
